...
#define AI_AI4I_DATA_ACTIVATIONS_SIZES \
  { 768, }
#define AI_AI4I_DATA_ACTIVATIONS_SIZE     (768)
#define AI_AI4I_DATA_ACTIVATIONS_COUNT    (1)
#define AI_AI4I_DATA_ACTIVATION_1_SIZE    (768)



#define AI_AI4I_DATA_WEIGHTS_SIZES \
  { 45588, }
#define AI_AI4I_DATA_WEIGHTS_SIZE         (45588)
#define AI_AI4I_DATA_WEIGHTS_COUNT        (1)
#define AI_AI4I_DATA_WEIGHT_1_SIZE        (45588)
